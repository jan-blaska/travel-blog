const destinationsList = [
    ...
    {
        translationKey: "DestinationsList.continent.asia",
        params: "asia",
        countries: [
    ...
    {
        translationKey: "DestinationsList.continent.africa",
        params: "africa",
        countries: [
            { translationKey: "DestinationsList.country.morocco", params: "morocco" }
        ]
    },
    {
        translationKey: "DestinationsList.continent.north-america",
        params: "north-america",
        countries: [
            { translationKey: "DestinationsList.country.dominican-republic", params: "dominican-republic" }
        ]
    }
];
